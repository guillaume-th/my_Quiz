 ...
 */
final class Version20211021091821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD �my_column VARCHAR(50) DEFAULT \'0\'');
        $this->addSql('ALTER TABLE question ADD my_column VARCHAR(50) DEFAULT \'0\'');
        ...
        $this->addSql('ALTER TABLE reponse ADD my_column VARCHAR(50) DEFAULT \'0\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse DROP my_column');
    }
}
